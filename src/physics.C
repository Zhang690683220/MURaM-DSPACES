...
void PhysicsData::Show() const {
  ...
  cout << "RT Extended: " << endl
       << "  rt_ext_hlines  = " << rt_ext[i_ext_hlines] << endl
       << "  rt_ext_calines = " << rt_ext[i_ext_calines] << endl
       << "  rt_ext_mglines = " << rt_ext[i_ext_mglines] << endl
       << "  rt_ext_cor     = " << rt_ext[i_ext_cor] << endl
       << "  rt_ext_chr     = " << rt_ext[i_ext_chr] << endl;
